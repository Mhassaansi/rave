 ...
 * Use the [userProfileDetailFragment.newInstance] factory method to
...
class userProfileDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mView = inflater.inflate(R.layout.fragment_user_profile_detail, container, false)

        param1?.let {
            if (it != Constants.imageURL) {
                // R.drawable.user_dp
                ImageLoadUtil.loadImageNotFit(it, mView.iv_detail_pic, R.drawable.user_dp_placeholder)
            }
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment userProfileDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            userProfileDetailFragment().apply {
